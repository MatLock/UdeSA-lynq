...
public interface DmzProxyController {
  ...
  @Operation(
      ...
      description = "Relays `/skill-enhance`, `/translate` and `/detect-language` to lynq-ml's DMZ "
          + "API. Each turns text the caller already has into a result, so there is nothing for "
