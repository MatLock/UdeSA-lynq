const en = {
  ...
  jobDetail: {
    ...
    tailorDialog: {
      ...
      untitled: 'Untitled resume',
      loading: 'Loading your resumes…',
      loadError: 'We could not load your resumes. Close and try again.',
      pickTitle: 'Which resume should we work on?',
      pickSubtitle:
        'The agent works on a copy: the resume you pick stays untouched.',
      start: 'Start',
      starting: [
        'Reading the posting…',
        'Looking at your resume…',
        'Working out what the role asks for…',
      ...
      thinking: [
        ...
        'Checking nothing was invented…',
        'Reordering your experience…',
        'Polishing the wording…',
      ],
      turnsLeft: '{count} tweaks left',
      turnsLeftOne: '1 tweak left',
      turnsLeftNone: 'No tweaks left',
      turnInProgress: 'The agent is still working on your previous request. Hold on.',
      turnError: 'The agent could not answer. Try again.',
      exhausted:
      ...
      changesTitle: 'Changes in this turn',
      documentTab: 'Tailored resume',
      chatTab: 'Conversation',
      documentHeading: 'Your tailored resume',
      versionLabel: 'Version {version}',
      baseVersion: 'No changes yet',
      changedHint: 'The sections that changed in the last turn are highlighted.',
      apply: 'Use this resume and apply',
      applying: [
        'Rendering the PDF…',
      ...
      close: 'Close',
      discardTitle: 'Discard the tailored resume?',
      discardMessage:
