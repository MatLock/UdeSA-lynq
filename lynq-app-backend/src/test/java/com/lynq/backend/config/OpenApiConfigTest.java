...
class OpenApiConfigTest {
  ...
  private static final String EXPECTED_TITLE = "lynq-app-backend";
  ...
  @Test
  void lynqAppBackendOpenAPIReturnsNonNullOpenAPI() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();

    assertThat(openAPI, is(notNullValue()));
  }

  @Test
  void lynqAppBackendOpenAPIInfoHasExpectedTitle() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
  ...
  @Test
  void lynqAppBackendOpenAPIInfoHasExpectedVersion() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
  ...
  @Test
  void lynqAppBackendOpenAPIInfoHasExpectedDescription() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
  ...
  @Test
  void lynqAppBackendOpenAPIRegistersBearerAuthSecurityScheme() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
  ...
  @Test
  void lynqAppBackendOpenAPIBearerSchemeHasExpectedTypeAndScheme() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
  ...
  @Test
  void lynqAppBackendOpenAPIBearerSchemeHasExpectedBearerFormatAndDescription() {
    OpenAPI openAPI = openApiConfig.lynqAppBackendOpenAPI();
